odoo.define('product.generate_pricelist_new', function (require) {
    'use strict';
    ...
    var GeneratePriceList = AbstractAction.extend(StandaloneFieldManagerMixin, {
        ...
        willStart: function () {
            ...
            const fieldSetup = getPricelist.then(pricelistIds => {
                return this.model.makeRecord('report.product.report_pricelist_new', [{
                    name: 'pricelist_id',
                    type: 'many2one',
        ...
        _getHtml: function () {
            return this._rpc({
                model: 'report.product.report_pricelist_new',
                method: 'get_html',
                kwargs: {
        ...
        _onClickPrint: function () {
            return this.do_action({
                ...
                report_name: 'new_sales_report.report_pricelist_new',
                report_file: 'new_sales_report.report_pricelist_new',
                data: this._prepareActionReportParams(),
            });
        },
        /**
    ...
    core.action_registry.add('generate_pricelist_new', GeneratePriceList);
